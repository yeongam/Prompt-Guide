# Claude Code Session Reference Guard

- Slug: `claude-code-session-reference-guard`
- Event: `session_reference`
- Source: https://github.com/anthropics/claude-code
- Source commit: `b7784f2c63ed`
...
2. Do not assume GitHub Actions changed the live local Claude Code runtime.
...
Official Claude Code CLI: commands, hooks, and settings
