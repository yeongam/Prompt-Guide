# Claude Code Agent Programming

- Slug: `claude-code-agent-programming`
- Source: https://github.com/anthropics/claude-code
- Source commit: `005c5dade90c`
...
Compact checklist for building on Claude Code's CLI and skill system.
