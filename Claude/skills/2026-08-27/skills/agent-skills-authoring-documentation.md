# Agent Skills Authoring & Documentation

- Slug: `agent-skills-authoring-documentation`
- Source: https://github.com/anthropics/skills
- Source commit: `3b3fad96af16`
...
3. Use structured tool calls over ad hoc parsing.
4. Keep prompt and code paths short.
5. Verify with the narrowest relevant command.

## Output

Concise skill-authoring and documentation-maintenance checklist.
