...
1. Pull local Claude Code usage history and repo conventions.
2. Summarize common workflows, commands, and gotchas.
3. Produce a concise onboarding guide, not a full manual.

## Output

Onboarding guide generated from local usage history and repo docs.
