...
1. Review only the changed code, not the whole file.
2. Flag reuse, simplification, and efficiency opportunities.
3. Apply the fixes directly; leave bug-hunting to code-review.

## Output

Simplified diff with quality fixes applied.
